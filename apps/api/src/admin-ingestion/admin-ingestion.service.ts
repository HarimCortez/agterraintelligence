...
export class AdminIngestionService {
  ...
  async triggerErsLocalFoodEconomyRun(admin: AuthenticatedAdminUser): Promise<TriggerIngestionResponseDto> {
    const { id } = await this.ersLocalFoodEconomyIngestion.trigger();

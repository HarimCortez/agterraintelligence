...
export class AdminIngestionController {
  ...
  @Post("crp-county-practice/run")
  @RequirePermission("ingestion.run")
  triggerCrpCountyPracticeRun(@CurrentAdmin() admin: AuthenticatedAdminUser): Promise<TriggerIngestionResponseDto> {
    return this.ingestionService.triggerCrpCountyPracticeRun(admin);
  }

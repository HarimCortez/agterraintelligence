  ...
  async getPropertyById(id: string): Promise<RawPropertyDetailRow> {
    ...
    const sql = `
      SELECT
        ...
        psd.farmland_classification AS "soilFarmlandClassification",
        ...
        pacs.local_food_economy_year AS "agCensusLocalFoodEconomyYear",
        pacs.county_orchard_acres AS "agCensusCountyOrchardAcres",
        pacs.county_berry_acres AS "agCensusCountyBerryAcres",
        pacs.county_direct_farm_sales_pct AS "agCensusCountyDirectFarmSalesPct",
        pacs.county_agritourism_operations AS "agCensusCountyAgritourismOperations",
        pacs.county_agritourism_receipts_cents AS "agCensusCountyAgritourismReceiptsCents",
        ...
        pces.poverty_income_year AS "economicPovertyIncomeYear",
        pces.county_poverty_rate_pct AS "economicCountyPovertyRatePct",
        pces.county_child_poverty_rate_pct AS "economicCountyChildPovertyRatePct",
        pces.county_deep_poverty_rate_pct AS "economicCountyDeepPovertyRatePct",
        pces.county_per_capita_income_cents AS "economicCountyPerCapitaIncomeCents"
      FROM properties p
      LEFT JOIN opportunity_scores os ON p.id = os.property_id
      LEFT JOIN property_valuations pv ON p.id = pv.property_id
      ...
      GROUP BY p.id, p.address, p.county, p.state, p.acreage, p.asking_price_cents,
               ...
               pacs.local_food_economy_year, pacs.county_orchard_acres, pacs.county_berry_acres,
               pacs.county_direct_farm_sales_pct, pacs.county_agritourism_operations,
               pacs.county_agritourism_receipts_cents,
               ...
               pces.poverty_income_year, pces.county_poverty_rate_pct,
               pces.county_child_poverty_rate_pct, pces.county_deep_poverty_rate_pct,
               pces.county_per_capita_income_cents
    `;

...
function makeRow(overrides: Partial<RawPropertyDetailRow> = {}): RawPropertyDetailRow {
  return {
    ...
    agCensusLocalFoodEconomyYear: null,
    agCensusCountyOrchardAcres: null,
    agCensusCountyBerryAcres: null,
    agCensusCountyDirectFarmSalesPct: null,
    agCensusCountyAgritourismOperations: null,
    agCensusCountyAgritourismReceiptsCents: null,
    timberYear: null,
    ...
    economicCountyFarmingDependent: null,
    economicCountyHighNaturalAmenities: null,
    economicCountyRetirementDestination: null,

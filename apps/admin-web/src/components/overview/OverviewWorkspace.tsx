...
,{" "}
        ...
        , and{" "}
        <Link href="/ai-monitoring" className="text-action-primary underline">
          AI &amp; Model Monitoring
        </Link>{" "}
        are live. The rest of the admin console — Administration Settings — is built in a later pass.
      </div>
    </div>
  );
}
